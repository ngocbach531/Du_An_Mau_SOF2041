...
public class ChuyenDeJDialog extends javax.swing.JDialog {
    ...
    //Lấy số trang thông qua hàm countBD
    public void viewSoTrang() {
        if (_ChuyenDeDAO.countDB() % 10 == 0) {
            _soTrang = _ChuyenDeDAO.countDB() / 10;
        } else {
            _soTrang = _ChuyenDeDAO.countDB() / 10 + 1;
        }
        this.fillTable(1);
    ...
    public void fillTable(long trang) {
        ...
        model.setRowCount(0);
        try {
            List<ChuyenDe> list = _ChuyenDeDAO.fillTop(trang);
...
//                this.fillTable(_trang);
    ...
    public void edit() {
        ...
        ChuyenDe nv = _ChuyenDeDAO.selectById(macd);
        try {
            if (nv != null) {
    ...
    private void tblChuyenDeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblChuyenDeMouseClicked
        ...
        cd = _ChuyenDeDAO.selectAll().get(getIndex);
